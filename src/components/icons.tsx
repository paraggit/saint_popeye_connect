...
export const WindowsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg 
        ...
        className={className}
    >
        <path d="M3,12V3H12V12H3M3,21V13.5H12V21H3M13.5,3V12H21V3H13.5M13.5,21V13.5H21V21H13.5Z" />
    </svg>
);
...
export const DockerIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg
        ...
        className={className}
    >
        <path d="M22.08 10.59a2.5 2.5 0 0 0-1.7-4.39 3.5 3.5 0 0 0-6.88 0 2.5 2.5 0 0 0-1.7 4.4" />
        <path d="M4.53 12.08a4.5 4.5 0 0 0 8.06 2.45" />
        <path d="M17.5 13.5a2.5 2.5 0 0 0 0-5" />
